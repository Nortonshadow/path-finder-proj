    ...
    def planning(self, sx, sy, gx, gy):
        ...
        while open_set:
            ...
            for i, _ in enumerate(self.motion):
                ...
                if self.calc_grid_position(node.x, self.min_x) in self.jc_x and self.calc_grid_position(node.y, self.min_y) in self.jc_y:
                    node.cost -= (self.Delta_C2) * 0.95 * self.motion[i][2]
